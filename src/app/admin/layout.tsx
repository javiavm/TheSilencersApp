...
import { Newspaper, Package, Users } from 'lucide-react';
    ...
    <div className="container py-8 grid gap-8 md:grid-cols-[220px_1fr]">
      <aside>
        ...
        <nav className="flex flex-col gap-1 text-sm">
          ...
          <span className="px-3 py-2 text-muted-foreground inline-flex items-center gap-2 cursor-not-allowed">
            <Users className="h-4 w-4" /> Servidores <span className="text-xs">(D9-10)</span>
          </span>
        </nav>
      </aside>
